...
Compile / mainClass := Some("com.gu.identity.formstackbatonrequests.FormstackBatonUpdateDynamoLambdaLocalRun")
Compile / run / mainClass := Some("com.gu.identity.formstackbatonrequests.FormstackBatonUpdateDynamoLambdaLocalRun")
run / envVars := Map(
