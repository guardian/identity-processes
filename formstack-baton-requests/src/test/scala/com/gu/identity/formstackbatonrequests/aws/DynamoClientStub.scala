...
class DynamoClientStub(
  ...
  override def updateMostRecentTimestamp(lastUpdatedTableName: String, accountNumber: Int, newTimestamp: LocalDateTime): Either[Throwable, Unit] = updateMostRecentTimestampResponse
